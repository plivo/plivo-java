...
[plivo-2.0.0-jar-with-dependencies.jar](http://sdk.plivo.com/java/plivo-2.0.0-jar-with-dependencies.jar)

[plivo-2.0.0.jar](http://sdk.plivo.com/java/plivo-2.0.0.jar) - use this if you have issues with conflicting jars in your project. See the pom.xml for the list of dependencies you will need to include.
