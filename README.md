...
You can use this SDK by adding it as a dependency in your dependency management tool. Alternatively, you can use the [JAR file](https://search.maven.org/remotecontent?filepath=com/plivo/plivo-java/5.19.0/plivo-java-5.19.0.jar).
...
```
compile 'com.plivo:plivo-java:5.19.0'
```
...
4. The testing files can be added to `<sdk_dir_path>/java-sdk-test` in host  
 (or `/usr/src/app/java-sdk-test/` in container)
