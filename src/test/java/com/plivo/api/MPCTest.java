...
public class MPCTest extends BaseTest {
  ...
  public void updateParticipant() throws Exception {
    ...
    final String mpcUuid = "12345678-90123456";
    ...
    MultiPartyCall.participantUpdater(MultiPartyCallUtils.mpcUuid(mpcUuid),
      participantId).mute(false).hold(false).update();
    assertRequestWithPayload("POST", "MultiPartyCall/uuid_%s/Participant/%s/",
      payload, mpcUuid, participantId);
  }
