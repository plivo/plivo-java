...
public abstract class BrandsLister<T extends BaseResource> extends BaseRequest<T> implements Iterable<T> {

  protected Integer limit = null;
  protected Integer offset = null;

  @Override
  public BrandsLister<T> client(final PlivoClient plivoClient) {
   ...
   */
  public BrandsLister<T> limit(final Integer limit) {
    this.limit = limit;
    return this;
  }
   ...
   */
  public BrandsLister<T> offset(final Integer offset) {
    this.offset = offset;
    return this;
  }

  protected abstract Call<MessagingListResponse<T>> obtainCall() throws PlivoValidationException;

  /**
   * Actually list instances of the resource.
   */
  public MessagingListResponse<T> list() throws IOException, PlivoRestException, PlivoValidationException {
    validate();
    Response<MessagingListResponse<T>> response = obtainCall().execute();
  ...
  public Iterator<T> iterator() throws IterableError {
    ...
    return new Iterator<T>() {
      ...
      public boolean hasNext() {
        ...
        try {
          MessagingListResponse<T> itemList = BrandsLister.this.list();
