...
public class PlivoClient {
  ...
  protected static String VOICE_BASE_URL = "https://api-dev.voice.plivodev.com/v1/";
  protected static String VOICE_FALLBACK1_URL = "https://api-dev.voice.plivodev.com/v1/";
