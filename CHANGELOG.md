...
- Added `haEnabled` optional parameter to `PhoneNumberCreator` for enabling HA functionality during phone number rent
- Added `fallbackNumber` field to `PhoneNumberCreationStatus` response
